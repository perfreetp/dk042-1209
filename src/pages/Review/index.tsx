    ...
    <div className="space-y-7">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="glass-card p-6">
            <h2 className="text-lg font-semibold text-ink-900 font-serif mb-4">📋 上线清单</h2>
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-gradient-to-br from-emerald-50 to-brand-50 border border-emerald-200/60">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-ink-500">生成于 {review?.publishedAt ? formatDateTime(review.publishedAt) : formatDateTime(new Date().toISOString())}</div>
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { icon: Shield, label: '安全 & AB 兼容', desc: '移除实验分组逻辑、清理 AB SDK', done: false },
                    { icon: Users, label: '跨团队同步', desc: '设计、运营、客服团队通知', done: false },
                    { icon: BookOpen, label: '文档更新', desc: '产品文档、埋点文档、帮助中心', done: false },
                    { icon: FileCheck2, label: '数据埋点验证', desc: '上线后 48h 数据核对', done: false },
                  ].map((t, i) => (
                ...
                <button className="w-full mt-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-ink-900 to-ink-800 text-white text-sm font-medium flex items-center justify-center gap-2 hover:opacity-90 shadow-lg shadow-ink-900/20">
